...
def theme_tokens(mode: str) -> dict[str, str]:
    ...
    shared = {
        ...
        "accent": "#38bdf8",
        # Radius scale (launch visual system)
        "radius-sm": "10px",
        "radius": "14px",
        "radius-md": "14px",  # alias of radius
        "radius-lg": "18px",
        "radius-pill": "999px",
        # Spacing scale
        "space-1": "4px",
    ...
    if normalize_theme(mode) == THEME_LIGHT:
        return {
            **shared,
            ...
            "confirmed-bg": "rgba(59, 130, 246, 0.08)",
            "estimated-bg": "rgba(125, 183, 255, 0.10)",
        }
    return {
        **shared,
        "bg": "#0b1220",
        ...
        "confirmed-bg": "rgba(59, 130, 246, 0.12)",
        "estimated-bg": "rgba(125, 183, 255, 0.10)",
    }
