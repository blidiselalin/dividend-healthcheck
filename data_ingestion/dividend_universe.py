...
# High-quality S&P 500 dividend payers beyond the Aristocrats (sector leaders, REITs, utilities, etc.)
_SUPPLEMENTAL_SP500_DIVIDEND: tuple[str, ...] = (
    "AAPL", "AEP", "ALL", "AMGN", "AMT", "AVB", "AVGO", "BAC", "BK", "BMY",
    "CAG", "CCI", "CME", "COP", "COST", "CSCO", "D", "DE", "DLR", "DUK",
    "EOG", "EQIX", "EQR", "ESS", "EXC", "GILD", "GIS", "GS", "HD", "HON",
    "HST", "HUM", "ICE", "INTC", "JPM", "K", "KHC", "KMI", "L", "LMT",
    "LLY", "LOW", "MET", "MMC", "MO", "MPC", "MRK", "MS", "MSFT", "NDAQ",
    "OKE", "PFE", "PM", "PNC", "PSX", "QCOM", "REG", "RTX", "SBAC", "SCHW",
    "SLB", "SO", "STT", "STZ", "T", "TFC", "TRGP", "TRV", "TXN", "UNH",
    "UNP", "USB", "VICI", "VLO", "VZ", "WEC", "WMB", "WM", "WY", "XEL",
    "ZTS",
)
...
def fetch_aristocrats_from_wikipedia() -> List[str]:
    ...
    request = urllib.request.Request(_ARISTOCRATS_URL, headers={"User-Agent": _USER_AGENT})
...
def _load_bundled(*, require_count: int = 50) -> Optional[List[str]]:
...
def get_top_dividend_symbols(*, refresh: bool = False) -> List[str]:
    ...
    return sorted({symbol for symbol in DIVIDEND_KINGS + DIVIDEND_ARISTOCRATS if symbol not in DELISTED_SYMBOLS})
