...
def test_get_top_dividend_symbols_returns_about_one_hundred():
...
def test_build_top_dividend_symbols_filters_to_sp500(monkeypatch):
    monkeypatch.setattr(
...
def test_load_bundled_top_dividend_json():
...
def test_config_all_dividend_stocks_matches_bundle():
    from config import ALL_DIVIDEND_STOCKS, TOP_DIVIDEND_STOCKS
